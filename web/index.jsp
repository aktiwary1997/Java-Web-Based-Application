<%-- 
    Document   : index
    Created on : 23 Mar, 2021, 2:15:27 AM
    Author     : hp
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="java.sql.Connection"%>
<%@page import="com.ashu.connection.DbConnection"%>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul>
                            ...
                            <li> <a href="https://www.infosys.com/careers/apply.html"> Infosys </a> </li>
                            <li> <a href="https://careers.wipro.com/careers-home/"> Wipro </a> </li>
                            <li> <a href="https://www.ibm.com/employment/"> IBM </a> </li>
